...
import * as difficultySuite from './suites/difficulty.test';
import * as validationSuite from './suites/validation.test';
import * as loggerSuite from './suites/logger.test';
import * as promptSuite from './suites/prompt.test';
